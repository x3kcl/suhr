...
su -c "docker-compose -f /home/cloud/docker/docker-compose.yml stop apache" cloud &
BACK_PID=$!
wait $BACK_PID
...
su -c "docker-compose -f /home/cloud/docker/docker-compose.yml up -d apache" cloud &
BACK_PID=$!
wait $BACK_PID
rm /root/www.tar.bz
echo "Deployment END"